...
@Data
@NoArgsConstructor
@Table(name = "APPLICANT_USER_LOGIN_HISTORY")
public class ApplicantUserLoginHistory {
     ...
     * @param userName
     */
    public ApplicantUserLoginHistory(String loginIp, String userAgent, String userName) {
        super();
