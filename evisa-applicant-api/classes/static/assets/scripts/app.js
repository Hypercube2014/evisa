...
var App = (function () {
    ...
    $(".page-sidebar")
      ...
      .on("mouseenter", function () {
        ...
        body
          ...
          .addClass("page-sidebar-hover-on");
  ...
  /* handle sidebarower
  var handlesidebarower = function () {
     //console.log("merde");
     /* if ($(".sidebarower").hasClass("open"))
       $(".sidebarower").removeClass("open");
     else $(".sidebarower").addClass("open");
   }; */

  // Handles sidebar toggler to close/hide the sidebar.
  var handleSidebarToggler = function () {

    // Handle custom sidebar
  ...
  var handleHorizontalMenu = function () {
    ...
    $(".header").on(
      "click",
      ".hor-menu .hor-menu-search-form-toggler",
      function (e) {
  ...
  var handleAccordions = function () {
    ...
    jQuery("body").on(
      "click",
      ".accordion.scrollable .accordion-toggle",
      function () {
    ...
    var setLayout = function () {
      ...
      if (layoutOption === "boxed") {
        ...
        if (footerOption === "fixed") {
          $(".footer").html(
            '<div class="container">' + $(".footer").html() + "</div>"
          );
        } else {
  ...
  return {
    ...
    init: function () {
      ...
      handlesidebarower(); // handles sidebarower
      //core handlers
