...
document.write("                            <a href='applicationsListIMO.html' style='color:#ffffff;'><i class='fa fa-circle text-success'></i>");
document.write("                            Decision Maker</a>");
document.write("                        </div>");
document.write("                    </div> ");
...
document.write("					<a href='applicationsListIMO.html'>");
...
document.write("					<a href='searchApplicationsIMO.html'>");
document.write("					<i class='fa fa-book'></i> ");
document.write("					<span class='title'>eVisa Processing</span>");
document.write("					</a>");
document.write("				</li>");
